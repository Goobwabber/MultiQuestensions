...
DECLARE_CLASS_CODEGEN(MultiQuestensions::Environments, MQEAvatarNameTag, UnityEngine::MonoBehaviour,
    ...
    DECLARE_INSTANCE_METHOD(void, SetPlatformData, MultiQuestensions::Players::MpPlayerData* data);
    DECLARE_INSTANCE_METHOD(void, SetSimplePlayerInfo, GlobalNamespace::IConnectedPlayer* simplePlayer);
    DECLARE_INSTANCE_METHOD(void, HandlePlatformData, GlobalNamespace::IConnectedPlayer* player, MultiQuestensions::Players::MpPlayerData* data);
    ...
    MultiQuestensions::event_handler<GlobalNamespace::IConnectedPlayer*, MultiQuestensions::Players::MpPlayerData*> _platformDataEventHandler;
    MultiQuestensions::event_handler<GlobalNamespace::IConnectedPlayer*, MultiQuestensions::Players::MpexPlayerData*> _mpexPlayerDataEventHandler;
